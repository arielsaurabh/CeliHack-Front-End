  ...
  componentWillMount() {
    this._panResponder = PanResponder.create({
      ...
      onPanResponderRelease: (e, {vx, vy}) => {
        ...
        if (Math.abs(this.state.pan.x._value) < CLICK_THRESHOLD && Math.abs(this.state.pan.y._value) < CLICK_THRESHOLD) {
          this.props.handleClicked(this.state.card);
        }
      }
    })
  }
...
SwipeCards.propTypes = {
    ...
    handleClicked: React.PropTypes.func,
};
