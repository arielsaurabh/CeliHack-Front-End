                    ...
                    <View  style={{ width:theme.deviceWidth, height:131, flexDirection:'row', margin:3, borderBottomWidth:1, borderColor: theme.customColor}}>
                        ...
                        <View style={{flex:3}}>
                            <View style={{flex:3, flexDirection:'row'}}>
                                <View style={{flex:3}}>
                                    <View style={{flex:1}}>
                                        <Text numberOfLines={1} style={{marginLeft:5, color:theme.customColor, flex:1}}>{favourite.DishName}</Text>
                                    </View>
                                    <View style={{flex:2}}>
                                        <View style={{flex:1, flexDirection:'row'}}>
                                            ...
                                            <View style={{flex:5}}>
                                                <View style={{flex:1}}>
                                                    <Text numberOfLines={1} style={{color:theme.customColor}}>
                                        ...
                                        <View style={{flex:1}}>
                                            <Text style={{marginLeft: 10, color:'#74cdc1', textDecorationLine: 'underline'}}>{distance}</Text>
                                        </View>
                                    </View>
                                </View>
                                <View style={{flex:0.7}}>
                            ...
                            <View style={{flex:2, flexDirection:'row'}}>
                                <View style={{flex:2}}>
                                    <View style={{flex:1, flexDirection:'row'}}>
                                        ...
                                        <View style={{flex:3}}>
                                            <View style={{flex:1}}>
                                                <Text style={{marginLeft:5, color:theme.customColor}}>{favourite.SideEffectBad + favourite.SideEffectGood}</Text>
                                            </View>
                                        </View>
                                    </View>
                                    <View style={{flex:1}}>
                                        <Text style={{marginLeft:10, color:theme.customColor}}>Side Effects</Text>
                                    </View>
                                </View>
                                <View style={{flex:2, flexDirection:'row'}}>
                                    <View style={{flex:4}}>
            ...
            <Container theme={theme}>
                <Header style={{ backgroundColor:theme.brandPrimary, justifyContent: 'space-between', height: theme.headerHeight}}>
                    <Grid>
                        ...
                        <Col style={{flex:5, justifyContent:'center'}}><Text style={styles._titleText}>Favorites</Text></Col>
                        <Col style={[styles._alignCol, {flex:5}]}>
                            <TouchableOpacity style={styles._alignCol}
                                onPress={() => this.navigateTo('addnewdish')}>
...
export default connect(null, bindAction)(Favourite);
