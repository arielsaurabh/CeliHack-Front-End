...
class ViewMoreReview0 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            reviews: [],
                    ...
                    <View  key={i} style={{margin: 5}} >
                        <CardItem style={{ flex:1}}>
                            <View style={{flexDirection:'row'}}>
                                <Image style={{width:28, height:23}} resizeMode={'stretch'} source={review.Effect===0?require('../../../images/emoji2.png'): require('../../../images/emoji1.png')}/>
                ...
                <Header style={{justifyContent: 'flex-start', paddingTop: (Platform.OS==='ios') ? 23 : 9, height: theme.headerHeight}}>
                    <Grid>
                        ...
                        <Col style={{flex:8, justifyContent:'center', alignItems:'center'}}>
                            <Text style={styles.titleText}>כל התגובות</Text>
                        </Col>
                        <Col style={{flex:1}}>
                        </Col>
                    </Grid>
...
export default connect(null, bindAction)(ViewMoreReview0);
