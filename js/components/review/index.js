...
import {globalPresentation} from '../presentation/index.js';
                ...
                <Header style={{justifyContent: 'flex-start', paddingTop: (Platform.OS==='ios') ? 23 : 9, height: theme.headerHeight}}>
                    <Grid>
                        ...
                        <Col style={{flex:8, justifyContent:'center', alignItems:'center'}}>
                            <Text style={styles._titleText}>Review</Text>
                        </Col>
                        <Col style={{flex:1}}>
                        </Col>
                    </Grid>
                            ...
                            <CardItem>
                                <View style={{flexDirection:'row'}}>
                                    ...
                                    <Text style={styles._allReview}>
                                        All reviews: {this.props.effectCount}
                                    </Text>
                                </View>
                                <View style={styles._view1}>
                                    <Text style={{color:theme.customColor}}>Side Effects</Text>
                                ...
                                <View style={styles._view3}>
                                     ...
                                     />
                                     <Text style={{color:theme.customColor, marginLeft:10}}>Present My User Name</Text>
                                </View>
                            </CardItem>
                        </Card>
                        <Button primary block textStyle={{color: theme.textColor}} onPress={() => this.AddReviewData()}>SAVE</Button>
                    </View>
                </Content>
            </Container>
        )
...
export default connect(null, bindAction)(Review);
